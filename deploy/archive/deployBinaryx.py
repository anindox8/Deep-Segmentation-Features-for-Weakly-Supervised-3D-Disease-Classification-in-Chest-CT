...
def predict(args):
   ...
   # Read CSV with Validation/Test Set
    ...
    deployclf_data.to_csv("LungsBinary3D_Fold-1_150K_Steps.csv", encoding='utf-8', index=False)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_path',   '-m', default='/Local/scripts/lungs/classification/weights/16072019/Fold_1/Fold_1Step121500valloss0.19675')
    parser.add_argument('--csv',          '-d', default='/Local/scripts/lungs/classification/feed/csv/Lung_CV-Validation-Fold-1.csv')
