...
trainX_hdf     =  h5py.File('/DataFolder/lungs/Final_1593/HDF5/trainX/Normal.h5', MODE)
trainY_hdf     =  h5py.File('/DataFolder/lungs/Final_1593/HDF5/trainY/Normal.h5', MODE)
trainZ_hdf     =  h5py.File('/DataFolder/lungs/Final_1593/HDF5/trainZ/Normal.h5', MODE)
...
for f in files:
    ...
    # Patch Export
    trainX_hdf.create_dataset(subject_id, data=np.expand_dims(img[:,:,:,:,0], axis=4))     # 2 CT Patches                         (Baseline Method)
    trainY_hdf.create_dataset(subject_id, data=img)                                        # 2 CT + AggregatedFeatureMap Patches  (Standard Method)
    trainZ_hdf.create_dataset(subject_id, data=imgZ)                                       # 2 CT + 13FeatureMaps Patches         (Experimental Method)
