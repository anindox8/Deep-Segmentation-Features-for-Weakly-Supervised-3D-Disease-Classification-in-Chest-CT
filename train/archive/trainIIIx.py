...
PREFETCH_CACHE_SIZE =  BATCH_SIZE*3
MAX_STEPS           =  150000

LR_INITIAL          =  0.001
LRDECAY_STEPS       =  6130    # 60 Epochs = 6130 Steps
    ...
    try:
        for _ in range(MAX_STEPS // EVAL_EVERY_N_STEPS):
            ...
            if args.run_validation:
                ...
                EPOCH_DISPLAY = int( int(results_val['global_step']) / 102.16 )
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_path',   '-p', default='/Local/scripts/lungs/classification/weights/29072019/Fold_1')
    parser.add_argument('--train_csv',    '-t', default='/Local/scripts/lungs/classification/feed/csvIII/Lung_CV-Training-Fold-1.csv')
    parser.add_argument('--val_csv',      '-v', default='/Local/scripts/lungs/classification/feed/csvIII/Lung_CV-Validation-Fold-1.csv')
    ...
    NUM_GPUS = len(args.cuda_devices) - 1
    print("Number of Allocated GPUs: {}".format(NUM_GPUS))
