...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_path',   '-p', default='/Local/scripts/lungs/classification/weights/FINAL/Z/Z_vis')
    parser.add_argument('--train_csv',    '-t', default='/Local/scripts/lungs/classification/feed/csvIV_Z/Lungs_CV-Training-Fold-2.csv')
    parser.add_argument('--val_csv',      '-v', default='/Local/scripts/lungs/classification/feed/csvIV_Z/Lungs_CV-Validation-Fold-2.csv')
